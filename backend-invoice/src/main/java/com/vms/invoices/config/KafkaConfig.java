package com.vms.invoices.config;
...
public class KafkaConfig {
    ...
    @Value("${invoice.topic:invoice-submitted}")
    ...
    public ConsumerFactory<String, InvoiceEvent> consumerFactory() {
        JsonDeserializer<InvoiceEvent> deserializer = new JsonDeserializer<>(InvoiceEvent.class);
    ...
    public NewTopic invoiceTopic() {
        return new NewTopic(invoiceTopic, 1, (short) 1);
    }
